					...
					<div id="sidebar-menu" class="sidebar-menu">
						...
						<ul>
							...
							<li class="submenu">
								...
								<a href="<?php echo base_url();?>Dashboard"><i class="la la-user"></i> <span>Send Notification</span> <span class="menu-arrow"></span></a>

								<ul style="display: none;">

								<li><a href="<?php echo base_url();?>notification">Notification List</a></li>
