								...
								<input type="hidden" class="form-control" name="hr_id" value="<?php echo $hr_id;?>">
									...
									<div class="profile-img-wrap edit-img">
											...
											<?php  
											 ...
											 if(($ProfileImage!='' && file_exists(base_path_hr().'/upload/hr/'.$ProfileImage))){ ?>

												<img class="inline-block" src="<?php echo base_url_hr(); ?>upload/hr/<?php echo $ProfileImage; ?>"  id="blah">
