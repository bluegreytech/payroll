...
class Company_model extends CI_Model
{
	...
	function companycompliance_insert(){
		 $compliancedetail=get_one_record('tblcompanycompliances','companyid',$this->session->userdata('companyid'));
			...
			$complianceid=$this->input->post('complianceid');
			if($this->input->post('compliancetypeid')=='1'){
				$compliance_id= $compliancedetail->complianceid;
				  $data=array(
						'complianceid'=>$this->input->post('complianceid'),
				...
				$compliance_id= $compliancedetail->compliancedeductionid;
                $data=array(
						'complianceid'=>$this->input->post('complianceid'),
						'compliancename'=>$this->input->post('compliancename'),
						'compliancepercentage'=>$this->input->post('compliancepercentage'),
			...
			echo $compliance_id;
			//echo "<pre>";print_r($compliancedetail->complianceid);die;
		
			//print_r($data);die;
			$this->db->where("complianceid",$complianceid);
			$this->db->update('tblcompanycompliances',$data);	
			return 1;	  
