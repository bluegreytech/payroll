                ...
                <div class="content container-fluid">				
					...
					<div class="row">
						<div class="col-sm-4 col-5">
							<h4 class="page-title">Employee Netpay Report</h4>
						</div>
					...
					<!-- Search Filter -->
					<!-- Search Filter -->
<form method="post" action="<?php echo base_url();?>reports/searchnetpay" id="frm_search">
	...
	<div class="col-md-1"> 
		<a href="<?php echo base_url()?>Reports/<?php echo $redirect_page;?>" class="btn btn-info"><i class="fa fa-refresh"></i></a> 	
					...
					<tbody>
						...
						<td><i class="fa fa-inr"></i> <?php echo $row->netpay;?></td>						
