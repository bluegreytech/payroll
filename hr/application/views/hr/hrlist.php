					...
					<tbody>
						...
						<div class="dropdown dropdown-action">
							...
							<div class="dropdown-menu dropdown-menu-right">
								<a class="dropdown-item"  onclick="editdata('<?php echo $row->hr_id; ?>')" data-toggle="modal" data-target="#add_salary" >
								<i class="fa fa-pencil m-r-5"></i> Edit</a>
								<a class=" dropdown-item" onclick="deletedata('<?php echo $row->hr_id; ?>','<?php echo $row->ProfileImage ;?>')" data-toggle="modal" data-target="#delete_admin"><i class="fa fa-trash-o m-r-5"></i>Delete</a>
							</div>
						</div>
						</td>
			...
			<div class="modal-content">
				<div class="modal-body">
					<div class="form-header">
						<h3>Delete HR</h3>
						<p>Are you sure want to Cancel this hr?</p>
					</div>
